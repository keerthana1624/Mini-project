...
if(!isset($_SESSION['is_adminlogin'])){
  if(isset($_REQUEST['aEmail'])){
    ...
    $sql = "SELECT email, password FROM adminlogin WHERE email='".$aEmail."' AND password='".$aPassword."' limit 1";
...
<body>
 ...
 <nav class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
    <a href="index.php" class="navbar-brand">CSSMS</a>
    ...
    <div class="collapse navbar-collapse" id="myMenu">
      <ul class="navbar-nav pl-5 custom-nav">
        ...
        <li class="nav-item"><a href="loginpage.php" class="nav-link">Logout</a></li>
  ...
  <div class="mb-3 text-center mt-5" style="font-size: 30px;">
    ...
    <span>Car Showroom Service Managment System</span>
  </div>
  <p class="text-center" style="font-size: 20px;"> <i class="fas fa-user-secret text-danger"></i> <span>Admin Area</span>
  </p>
