...
<head>
	...
	<title>Service Engineer Register page</title>
      ...
      <div class="container">
        <div class="card mx-auto" style="width: 30rem;">
              <img class="card-img-top mx-auto" style="width: 40%; "src="reg.png" alt="icon">
                <div class="card-header text-center text-white bg-primary" ><h3>Service Engineer Registration</h3></div>
                  <div class="card-body">
                <form action="#" method="post">
                  ...
                  <div>
                  <input type="text"  id="se_id" class="form-control" name="se_id" placeholder="SE-ID" required/><br>
                  </div>
                  <div>       
                  ...
                  <div>
                  <input type="text" id="qualification" name="qualification" class="form-control"  placeholder="QUALIFICATION" required><br>        
                  </div>
                  <div>
                  <input type="text" id="experience" name="experience" class="form-control"  placeholder="EXPERIENCE" required> <br>       
                  </div>
                  <div>
