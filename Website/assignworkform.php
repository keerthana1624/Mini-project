 ...
 if(isset($_REQUEST['assign'])){
  ...
  if(($_REQUEST['request_id'] == "") || ($_REQUEST['request_info'] == "") || ($_REQUEST['requestdesc'] == "") || ($_REQUEST['requestername'] == "") || ($_REQUEST['address1'] == "") || ($_REQUEST['address2'] == "") || ($_REQUEST['requestercity'] == "") || ($_REQUEST['requesterstate'] == "") || ($_REQUEST['requesterzip'] == "") || ($_REQUEST['requesteremail'] == "") || ($_REQUEST['requestermobile'] == "") || ($_REQUEST['assigntech'] == "") || ($_REQUEST['inputdate'] == "")){
   ...
   $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
    ...
    $sql = "INSERT INTO assignwork_tb (ruser_id, request_id, request_info, request_desc, requester_name, requester_add1, requester_add2, requester_city, requester_state, requester_zip, requester_email, requester_mobile, assign_tech,  assign_date, se_id) VALUES ('$ruser_id', '$rid', '$rinfo','$rdesc', '$rname', '$radd1', '$radd2', '$rcity', '$rstate', '$rzip', '$remail', '$rmobile', '$rassigntech','$rdate', '$rse')";
...
<div class="col-sm-5 mt-5 jumbotron">
  ...
  <form action="" method="POST">
    ...
    <div class="form-group">
      <label for="a">Assign to Service Engineer</label>
      <input type="text" class="form-control" id="assigntech" name="assigntech" >
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="se_id">Engineer Id</label>
        <input type="text" class="form-control" id="se_id" name="se_id">
      </div>
      <div class="form-group col-md-6">
